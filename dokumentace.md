...
![System Context Diagram](./prezentace/system-context.png)
*C4 diagram of the System Context: Projects*

## Core features

The `Projects` module provides the following features:

- **Project management** - Teachers can create new projects, edit existing projects, and delete projects. Students can search for projects, filter projects, and sign up for projects.
- **Communication** - Students and teachers can communicate with each other within the project team. The communication is provided by a chat interface.
- **Notifications** - The `Projects` module provides notifications to the `SIS` about the status of the project. The `SIS` can then notify the user about the status of the project.
- **Project files** - Students can upload files to the project. Teachers can view and download files from the project.
- **Project details** - Students and teachers can view project details, including the project supervisor, enrolled students, and submitted files.
...
![Module Diagram](./prezentace/modul.png)
...
![Teacher Web Application Diagram](./prezentace/projekt-manager-web-app-ucitel.png)
...
![Student Web Application Diagram](./prezentace/projekt-manager-web-app-student.png)
...
![Communication Web Application Diagram](./prezentace/komunikace-web-app.png)
...
Communication server provides business and persistent logic. It is responsible for communication between all members of the project. It has both a cache and a database. The cache is used for storing the most recent messages and the database is used for storing all messages.

![Comunication Server Diagram](./prezentace/komunikace-server.png)
...
![Project Manager Server Diagram](./prezentace/projekt-manager-server.png)
...
![Deployment Diagram](./prezentace/deployment.png)
